...
stats:::plot.hclust(NEhc.ward,  hang = -1, labels = FALSE, bty = "n", sub = "", ylab = "",
                    xlab = "Week", axes = FALSE, cex.main = 1.1,
                    cex.lab = 1.1)
title("NE Aus : Response Clustering", adj = 0)
axis(2)
...
stats:::plot.hclust(SEhc.ward,  hang = -1, labels = FALSE, bty = "n", sub = "", ylab = "Height",
                    xlab = "Week", axes = FALSE, cex.lab = 1.25, main = "")
...
text(7, -5.6, "Early", col = "black", cex = 1.1, xpd = TRUE)
text(15.5, -5.6, "Peak", col = "black", cex = 1.1, xpd = TRUE)
text(23.5, -5.6, "Late", col = "black", cex = 1.1, xpd = TRUE)
dev.off()
