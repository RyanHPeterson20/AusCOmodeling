...
load("Data/validation_refits_wo2019.rda") #RMSE/Psreds/Models w/o 2019/2020 data
...
png(filename = paste0("SI_FigDMI_SEcoefint_early_", season.years[i], ".png"),  width = 2050, height = 4150, res = 300)
plot_lagged_coef_panels(
  coefs_named_list = coefs1,
...
png(filename = paste0("SI_FigDMI_SEcoefint_peak_", season.years[i], ".png"),  width = 2000, height = 4150, res = 300)
plot_lagged_coef_panels(
  coefs_named_list = coefs2,
  vars_order = c("nino", "dmi", "tsa", "aao", "olr"),  # include OLR panel
  pch_map = c(nino = 21, dmi = 24, tsa  = 22, aao  = 23, olr  = 10),
