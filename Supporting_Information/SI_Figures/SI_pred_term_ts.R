...
plot_pred_ts_panels(
  ...
  sub_season = SE.mid,
  seasons = seasons,
  main_title = "(a) 2006/2007 Peak Wildfire Season",
  cex_main = 3.25,
...
plot_pred_ts_panels(
  ...
  sub_season = SE.mid,
  seasons = seasons,
  main_title = "(b) 2015/2016 Peak Wildfire Season",
  cex_main = 3.25,
  preds_ord = c("nino", "etio", "wtio", 
                "tsa", "sam", "olr"),
  pred_label_x_offset = 5,
...
plot_pred_ts_panels(
  ...
  sub_season = SE.mid,
  seasons = seasons,
  main_title = "(c) 2019/2020 Peak Wildfire Season",
  cex_main = 3.25,
  preds_ord = c("nino", "etio", "wtio", 
                "tsa", "sam", "olr"),
  pred_label_x_offset = 5,
...
plot_pred_ts_panels(
  ...
  sub_season = SE.mid,
  seasons = seasons,
  main_title = "(a) 2002/2003 Peak Wildfire Season",
  cex_main = 3.25,
  preds_ord = c("nino", "etio", "wtio", 
                "tsa", "sam", "olr"),
  pred_label_x_offset = 5,
...
plot_pred_ts_panels(
  ...
  sub_season = SE.mid,
  seasons = seasons,
  main_title = "(b) 2003/2004 Peak Wildfire Season",
  cex_main = 3.25,
  preds_ord = c("nino", "etio", "wtio", 
                "tsa", "sam", "olr"),
  pred_label_x_offset = 5,
...
plot_pred_ts_panels(
  ...
  sub_season = SE.mid,
  seasons = seasons,
  main_title = "(c) 2005/2006 Peak Wildfire Season",
  cex_main = 3.25,
  preds_ord = c("nino", "etio", "wtio", 
                "tsa", "sam", "olr"),
  pred_label_x_offset = 5,
