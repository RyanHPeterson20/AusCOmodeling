...
SEAus2_range <- c(-5, 5) #close enough to 5

# --- Plot 1: Nino ---
par(mar = c(3, 4.75, 2.5, 1))
#nino pch 21
...
abline(h = 0, lty = 2, lwd = 1.5)
text(x = 3, y = 4.15, labels ="WTIO",  col = "gray12", cex = cex.subtile)
...
points(SE23_etiolag, SE23_etiocoef, pch = 25, col = "black",
       bg =  alpha("darkorange2",.65) , cex = 2)
abline(h = 0, lty = 2, lwd = 1.5)
text(x = 3, y = 4.15, labels ="ETIO",  col = "gray12", cex = cex.subtile)
...
abline(h = 0, lty = 2, lwd = 1.5)
text(x = 3, y = 4.15, labels ="TSA",  col = "gray12", cex = cex.subtile)
...
points(SE23_aaolag, SE23_aaocoef, pch = 23, col = "black",
       bg =  alpha("darkorange2",.65) , cex = 2.25)
abline(h = 0, lty = 2, lwd = 1.5)
text(x = 3, y = 4.15, labels ="SAM",  col = "gray12", cex = cex.subtile)
...
plot(SE2.coef[1], 0, type = "n", main = "", 
     ylim = c(0,1), xlim = SEAus2_range, cex = 2, cex.axis = cex.num,
     xlab = "Coefficients", cex.lab = cex.label,
     yaxt = "n",  ylab = "")
...
segments(SE2.coef[10], int_2, SE2.coef[10], int_pt1, col = "forestgreen", lty = 2, lwd = line.width)
segments(SE2.coef[10], int_4, SE2.coef[10], int_pt1, col = "forestgreen", lty = 2, lwd = line.width)
## const
int_pt2 <- (int_3 + int_5)/2
segments(SE2.constcoef[10], int_3, SE2.constcoef[10], int_pt2, col = "magenta4", lty = 2, lwd = line.width)
segments(SE2.constcoef[10], int_5, SE2.constcoef[10], int_pt2, col = "magenta4", lty = 2, lwd = line.width)
## etio_lag8:tsa_lag31
## vary
int_pt3 <- (int_6 + int_7)/2
segments(SE2.varycoef[8], int_6, SE2.varycoef[8], int_pt3, col = "darkorange2", lty = 2, lwd = line.width)
segments(SE2.varycoef[8], int_7, SE2.varycoef[8], int_pt3, col = "darkorange2", lty = 2, lwd = line.width)
...
for (i in 1:length(links)) {
  grid.lines(
    ...
    gp = gpar(col = colors[i], lwd = line.width, lty = linetypes[i])
  )
}

#mtext("Coefficients", side = 2, outer = TRUE, padj = 0.5, cex = cex.label) # currently moved to ETIO ylab

#TODO: get these aligned correctly and increase label size
#add legends 
par(xpd = NA)
legend("topright", inset = c(0.000, 0.00),
       title = "Terms", cex = 2.25,
